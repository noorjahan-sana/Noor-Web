        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                ...
                <div className="flex flex-wrap w-full -m-4">
                    ...
                    {!(filterType) ? product.filter((obj) => obj.title.toLowerCase().includes(searchkey.toLowerCase())).slice(0, 4).map((item, index) => {
                ...
                <div className="flex flex-wrap w-full -m-4">
                    {product.filter((obj) => obj.category.toLowerCase() === filterType.toLowerCase())
                        .filter((obj) => obj.price <= filterPrice).slice(0, 4).map((item, index) => {
                            const { title, price, description, imageUrl } = item;
